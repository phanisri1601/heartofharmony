...
export const metadata: Metadata = {
  title: '3 BHK Flats in Hosur main road 2026 | Locality Guide for Hosur Road Buyers — Heart of Harmony',
  description: 'Thinking of buying a 3 BHK flat in Hosur main road? This complete locality guide covers the neighbourhood, schools, hospitals, metro access, commute times, pin code comparison and why Heart of Harmony is the standout 3 BHK option on Hosur Road in 2026.',

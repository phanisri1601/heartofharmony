...
export const metadata: Metadata = {
  title: 'Private Sky Garden Terraces at Heart of Harmony | 10 Ways to Use Your Outdoor Space, Hosur main road',
  description: 'Heart of Harmony features open-to-sky private garden terraces on every third floor of its 24-storey tower at Hosur main road. Discover 10 ways residents use these outdoor decks daily — from yoga to family sundowners.',

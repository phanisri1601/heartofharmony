...
export default function HomesPage() {
  return (
    <>
      <ContentHero
        title={homesHero.title}
        titleAccent={homesHero.titleAccent}
        accentNewLine
        intro={homesHero.intro}
        image="/images/homes/ckpc-heart-of-harmony-homes-3-3.5-4-bed-homes-page-banner.jpg"

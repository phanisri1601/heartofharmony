...
export const metadata: Metadata = {
  title: 'Heart of Harmony Amenities | 40+ Facilities — Clubhouse, Pool, Spa & Outdoor Sports, Hosur main road',
  description: 'Explore 40+ amenities at Heart of Harmony, Hosur main road — sky deck pool, gym, spa, sauna, pickleball, basketball, outdoor sports, banquet hall and co-working space across podium and rooftop clubhouse. Hosur Road, Bengaluru.',

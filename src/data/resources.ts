// Articles listed on /resources/ — mirrors the live site's blog archive at
// https://www.ckpcheartofharmony.com/resources/ exactly: same 20 posts, same
// order (as paginated 9/9/2 across pages 1–3 of the live archive), same
// titles, same links, and the same featured images the live site actually
// serves for each post (scraped directly from its per-post inline
// background-image CSS — including "CKPC-Secures-Long-Term-TCS-Office-Lease.jpg"
// being reused as the featured image for the "Thinking Behind (PX)" post,
// which looks like a mismatch but is genuinely what the live site displays).
...
export const articles = [
  ...
  {
    title: "Heart of Harmony Brochure: Everything You Need Before You Download",
    href: "/heart-of-harmony-brochure/",
    image: "/images/content/heart-of-harmony-brochure.webp",
  },
  // Page 2
  {
    title: "Heart of Harmony Master Plan: A Detailed Look at the Site Layout, Tower Design & Floor Plans",
    href: "/heart-of-harmony-master-plan/",
  ...
  {
    title:
      "Heart of Harmony Floor Plans: Smart 3 BHK, 3.5 BHK & 4 BHK Home Layouts Designed for Real Life",
  ...
  {
    title:
      "Private Sky Garden Terraces at Heart of Harmony — 10 Ways to Make the Most of Your Outdoor Space",
    href: "/private-gardens-on-every-three-floors-10-things-you-can-do-in-your-private-gardens/",
    image:
      "/images/content/private-gardens-on-every-three-floors-10-things-you-can-do-in-your-private-gardens.jpg",
  },
  {
  ...
  {
    title:
      "CKPC Properties Secures Long-Term TCS Office Lease — A Landmark for Grade A+ Commercial Real Estate in Bengaluru",
